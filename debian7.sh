#!/bin/bash
#
# Original script by fornesia, rzengineer, fawzya, konterku
...
echo "<pre>Setup by Fandy</pre>" > /home/vps/public_html/index.html
...
wget -O user-add "http://vira.cf/usernew.sh"
...
echo "user-add (Membuat Akun SSH)"  | tee -a log-install.txt
